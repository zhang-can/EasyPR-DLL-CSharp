...
class CPlateDetect {
 public:
  ...
  @param index
  */
  int plateDetect(Mat src, std::vector<CPlate> &resultVec, const int show_type, int type,
  ...
  @param index
  */
  int plateDetect(Mat src, std::vector<CPlate> &resultVec, const int show_type, int img_index = 0);
