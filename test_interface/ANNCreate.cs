...
{
    public partial class ANNCreate : Form
    {
        string folder_path = "";
        ...
        private void ANNCreate_Load(object sender, EventArgs e)
        {
        ...
        {
            string result_path = @"L:\Users\zc\Desktop\LPS\test_interface\bin\x64\Release\resources\dataset\ann";
